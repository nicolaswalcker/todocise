<template>
  <div class="grid grid-rows-[64px_1fr_64px] h-[100dvh] bg-background">
    <header class="w-full h-full flex items-center justify-around">
      ...
      <section class="w-auto flex gap-5">
        ...
        <UiButton :disabled="tasksStore.isTasksEmpty" aria-label="limpar tudo" variant="ghost" @click="tasksStore.clearTasks()">
